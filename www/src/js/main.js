...
require.register("src/components/base/index.js", function(exports, require, module) {
'use strict';
    ...
    if (bases.length) {
        ...
        try {
            for (var _iterator = bases[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                ...
                var $base = $(base);
                // do some jquery things with base component
            }
        } catch (err) {
...
require.register("src/components/carousel/index.js", function(exports, require, module) {
'use strict';
...
require.register("src/components/index.js", function(exports, require, module) {
'use strict';
...
require.register("src/components/ui/nav/index.js", function(exports, require, module) {
'use strict';
